...
---
This document covers the class <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> in <SwmPath>[base/src/lgapdb04.java](base/src/lgapdb04.java)</SwmPath>. We will explain:
...
2. The variables defined in <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken>.
3. The functions in <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> that utilize <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken>, explaining their roles in the premium calculation process.
...
<SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> is a private static inner class within <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> that serves as a container for intermediate calculation values used during the insurance premium calculation process. It holds various <SwmToken path="base/src/lgapdb04.java" pos="171:1:1" line-data="        BigDecimal riskAdjustment = new BigDecimal(input.riskScore - 100)">`BigDecimal`</SwmToken> fields representing exposures, base rates, discounts, and intermediate loading values. This class is used to organize and maintain the state of these values as the premium calculation progresses through multiple steps.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="245:5:5" line-data="    private void p400ExperienceMod(InputData input, CalculationAreas calc,">`p400ExperienceMod`</SwmToken> calculates the experience modification factor based on the insured's years in business and claims history. It updates the <SwmToken path="base/src/lgapdb04.java" pos="275:3:3" line-data="        output.experienceMod = expMod;">`experienceMod`</SwmToken> field in <SwmToken path="base/src/lgapdb04.java" pos="246:1:1" line-data="                                   OutputResults output) {">`OutputResults`</SwmToken> accordingly.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="281:5:5" line-data="    private void p500ScheduleMod(InputData input, CalculationAreas calc,">`p500ScheduleMod`</SwmToken> calculates the schedule modification factor considering building age, protection class, occupancy hazard, and exposure density. It caps the schedule modifier within defined bounds and updates the <SwmToken path="base/src/lgapdb04.java" pos="332:3:3" line-data="        output.scheduleMod = schedMod;">`scheduleMod`</SwmToken> field in <SwmToken path="base/src/lgapdb04.java" pos="282:1:1" line-data="                                 OutputResults output) {">`OutputResults`</SwmToken>.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="338:5:5" line-data="    private void p600BasePremium(InputData input, CoverageData coverage,">`p600BasePremium`</SwmToken> calculates the base premiums for each peril (fire, crime, flood, weather) using coverage data, base rates, and schedule modifiers. It updates the respective peril premiums and total premium in <SwmToken path="base/src/lgapdb04.java" pos="339:6:6" line-data="                                 CalculationAreas calc, OutputResults output) {">`OutputResults`</SwmToken>.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="453:5:5" line-data="    private void p900Discounts(InputData input, CoverageData coverage,">`p900Discounts`</SwmToken> calculates various discounts such as multi-peril discount, claims-free discount, and deductible credits. It updates discount-related fields in <SwmToken path="base/src/lgapdb04.java" pos="454:1:1" line-data="                              CalculationAreas calc, OutputResults output) {">`CalculationAreas`</SwmToken> and <SwmToken path="base/src/lgapdb04.java" pos="454:6:6" line-data="                              CalculationAreas calc, OutputResults output) {">`OutputResults`</SwmToken>.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="523:5:5" line-data="    private void p999Final(CalculationAreas calc, OutputResults output) {">`p999Final`</SwmToken> performs the final premium calculation by summing all components including base premium, catastrophe loading, expense and profit loading, discounts, and taxes. It updates the <SwmToken path="base/src/lgapdb04.java" pos="525:3:3" line-data="        output.totalPremium = output.baseAmount">`totalPremium`</SwmToken> field in <SwmToken path="base/src/lgapdb04.java" pos="523:12:12" line-data="    private void p999Final(CalculationAreas calc, OutputResults output) {">`OutputResults`</SwmToken>.
...
<SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> is instantiated in the <SwmToken path="base/src/lgapdb04.java" pos="131:5:5" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`calculatePremium`</SwmToken> method where it acts as a shared data structure to hold intermediate values during the premium calculation process. It is passed to several private methods such as <SwmToken path="base/src/lgapdb04.java" pos="136:1:1" line-data="        p200Init(inputData, coverageData, calc);">`p200Init`</SwmToken>, <SwmToken path="base/src/lgapdb04.java" pos="139:1:1" line-data="        p300LoadRates(inputData, calc);">`p300LoadRates`</SwmToken>, and <SwmToken path="base/src/lgapdb04.java" pos="142:1:1" line-data="        p400ExperienceMod(inputData, calc, outputResults);">`p400ExperienceMod`</SwmToken>, which perform specific steps of the calculation using the data stored in <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken>.

## Initialization with <SwmToken path="base/src/lgapdb04.java" pos="136:1:1" line-data="        p200Init(inputData, coverageData, calc);">`p200Init`</SwmToken>

The <SwmToken path="base/src/lgapdb04.java" pos="136:1:1" line-data="        p200Init(inputData, coverageData, calc);">`p200Init`</SwmToken> method initializes exposure calculations and other factors using the input data and coverage data, storing results in the <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> instance. This setup prepares the calculation context for subsequent steps.

## Loading rates with <SwmToken path="base/src/lgapdb04.java" pos="139:1:1" line-data="        p300LoadRates(inputData, calc);">`p300LoadRates`</SwmToken>

The <SwmToken path="base/src/lgapdb04.java" pos="139:1:1" line-data="        p300LoadRates(inputData, calc);">`p300LoadRates`</SwmToken> method uses the <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> instance to load base rates from the database. It processes predefined peril codes and default rates, updating the <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> with relevant rate information needed for premium calculations.

## Experience modification with <SwmToken path="base/src/lgapdb04.java" pos="142:1:1" line-data="        p400ExperienceMod(inputData, calc, outputResults);">`p400ExperienceMod`</SwmToken>

The <SwmToken path="base/src/lgapdb04.java" pos="142:1:1" line-data="        p400ExperienceMod(inputData, calc, outputResults);">`p400ExperienceMod`</SwmToken> method calculates the experience modification factor, which adjusts the premium based on historical data. It uses the <SwmToken path="base/src/lgapdb04.java" pos="133:1:1" line-data="        CalculationAreas calc = new CalculationAreas();">`CalculationAreas`</SwmToken> instance to read and update calculation values and outputs the final results.
