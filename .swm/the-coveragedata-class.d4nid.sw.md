...
---
This document covers the <SwmToken path="base/src/LGAPDB04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> class in <SwmPath>[base/src/LGAPDB04.java](base/src/LGAPDB04.java)</SwmPath>. We will explain:
...
2. The variables defined in <SwmToken path="base/src/LGAPDB04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken>.
3. The functions in <SwmToken path="base/src/LGAPDB04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> that interact with <SwmToken path="base/src/LGAPDB04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken>, including their roles in premium calculation.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="169:5:5" line-data="    private void p200Init(InputData input, CoverageData coverage, CalculationAreas calc) {">`p200Init`</SwmToken> initializes exposure calculations based on input data and coverage limits. It calculates risk adjustment factors and computes exposures such as building, contents, and business interruption exposures.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="435:5:5" line-data="    private void p800ExpenseAndProfit(CalculationAreas calc, OutputResults output) {">`p800ExpenseAndProfit`</SwmToken> calculates expense and profit loadings on the premium, applying predefined ratios to cover operational costs and profit margins.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="453:5:5" line-data="    private void p900Discounts(InputData input, CoverageData coverage,">`p900Discounts`</SwmToken> applies discounts to the premium based on multi-peril discounts, claims-free discounts, and deductible credits, reducing the overall premium accordingly.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="510:5:5" line-data="    private void p950Taxes(OutputResults output) {">`p950Taxes`</SwmToken> calculates taxes on the premium using a fixed tax rate and adds this amount to the total premium.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="523:5:5" line-data="    private void p999Final(CalculationAreas calc, OutputResults output) {">`p999Final`</SwmToken> performs the final premium calculations by summing all components including base premium, catastrophe loading, expense, profit, discounts, and taxes to produce the total premium.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="60">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="60:5:5" line-data="        public BigDecimal buildingLimit;">`buildingLimit`</SwmToken> in <SwmToken path="base/src/LGAPDB04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> stores the insured limit for the building coverage as a <SwmToken path="base/src/LGAPDB04.java" pos="60:3:3" line-data="        public BigDecimal buildingLimit;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="61">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="61:5:5" line-data="        public BigDecimal contentsLimit;">`contentsLimit`</SwmToken> stores the insured limit for the contents coverage as a <SwmToken path="base/src/LGAPDB04.java" pos="61:3:3" line-data="        public BigDecimal contentsLimit;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="62">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="62:5:5" line-data="        public BigDecimal biLimit;">`biLimit`</SwmToken> stores the insured limit for business interruption coverage as a <SwmToken path="base/src/LGAPDB04.java" pos="62:3:3" line-data="        public BigDecimal biLimit;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="63">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="63:5:5" line-data="        public BigDecimal fireDeductible;">`fireDeductible`</SwmToken> stores the deductible amount for fire peril coverage as a <SwmToken path="base/src/LGAPDB04.java" pos="63:3:3" line-data="        public BigDecimal fireDeductible;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="64">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="64:5:5" line-data="        public BigDecimal windDeductible;">`windDeductible`</SwmToken> stores the deductible amount for wind peril coverage as a <SwmToken path="base/src/LGAPDB04.java" pos="64:3:3" line-data="        public BigDecimal windDeductible;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="65">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="65:5:5" line-data="        public BigDecimal floodDeductible;">`floodDeductible`</SwmToken> stores the deductible amount for flood peril coverage as a <SwmToken path="base/src/LGAPDB04.java" pos="65:3:3" line-data="        public BigDecimal floodDeductible;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="66">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="66:5:5" line-data="        public BigDecimal otherDeductible;">`otherDeductible`</SwmToken> stores the deductible amount for other perils as a <SwmToken path="base/src/LGAPDB04.java" pos="66:3:3" line-data="        public BigDecimal otherDeductible;">`BigDecimal`</SwmToken>.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="67">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="67:5:5" line-data="        public int firePeril;">`firePeril`</SwmToken> is an integer flag indicating whether fire peril coverage is included (non-zero) or not (zero).
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="68">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="68:5:5" line-data="        public int crimePeril;">`crimePeril`</SwmToken> is an integer flag indicating whether crime peril coverage is included.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="69">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="69:5:5" line-data="        public int floodPeril;">`floodPeril`</SwmToken> is an integer flag indicating whether flood peril coverage is included.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="70">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="70:5:5" line-data="        public int weatherPeril;">`weatherPeril`</SwmToken> is an integer flag indicating whether weather peril coverage is included.
...
<SwmToken path="base/src/LGAPDB04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> is used as a container for insurance coverage limits such as <SwmToken path="base/src/LGAPDB04.java" pos="60:5:5" line-data="        public BigDecimal buildingLimit;">`buildingLimit`</SwmToken>, <SwmToken path="base/src/LGAPDB04.java" pos="61:5:5" line-data="        public BigDecimal contentsLimit;">`contentsLimit`</SwmToken>, and <SwmToken path="base/src/LGAPDB04.java" pos="62:5:5" line-data="        public BigDecimal biLimit;">`biLimit`</SwmToken>. It is instantiated and passed to multiple methods that perform calculations related to insurance premiums and risk adjustments.
...
<SwmToken path="base/src/LGAPDB04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> is also used in the <SwmToken path="base/src/LGAPDB04.java" pos="151:1:1" line-data="        p700CatLoading(coverageData, calc, outputResults);">`p700CatLoading`</SwmToken> method, which calculates catastrophe loading. The coverage limits help define the extent of catastrophe risk loading applied to the premium calculations.
