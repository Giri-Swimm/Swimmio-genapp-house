...
<SwmToken path="base/src/lgapdb04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> is a static inner class in the <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> class that represents the insurance coverage details for a commercial property. It holds various coverage limits, deductibles, and peril indicators that are used as inputs for calculating insurance premiums. This class acts as a data container to encapsulate coverage-related parameters that influence the premium calculation process.

<SwmSnippet path="/base/src/lgapdb04.java" line="124">

---

The function <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> is the constructor of the <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> class. It initializes the class with a database connection used for loading base rates and other data required for premium calculations.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="435:5:5" line-data="    private void p800ExpenseAndProfit(CalculationAreas calc, OutputResults output) {">`p800ExpenseAndProfit`</SwmToken> computes expense and profit loadings as percentages of the base premium. These loadings reflect operational costs and desired profit margins.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="453:5:5" line-data="    private void p900Discounts(InputData input, CoverageData coverage,">`p900Discounts`</SwmToken> applies discounts based on multi-peril coverage, claims-free history, and deductible credits. It reduces the premium accordingly.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="510:5:5" line-data="    private void p950Taxes(OutputResults output) {">`p950Taxes`</SwmToken> calculates taxes on the premium using a fixed tax rate and adds this to the total premium.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="523:5:5" line-data="    private void p999Final(CalculationAreas calc, OutputResults output) {">`p999Final`</SwmToken> performs final premium calculations by summing all premium components, applying modifiers, and setting the total premium in the output results.
...
The <SwmToken path="base/src/lgapdb04.java" pos="148:1:1" line-data="        p600BasePremium(inputData, coverageData, calc, outputResults);">`p600BasePremium`</SwmToken> method calculates base premiums for each peril. It receives <SwmToken path="base/src/lgapdb04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> to access coverage limits, which are essential for determining the base premium amounts before applying any modifiers.
...
<SwmToken path="base/src/lgapdb04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken> is also used in the <SwmToken path="base/src/lgapdb04.java" pos="151:1:1" line-data="        p700CatLoading(coverageData, calc, outputResults);">`p700CatLoading`</SwmToken> method, which calculates catastrophe loading. This method uses coverage limits to assess additional premium loadings related to catastrophic risk exposures.
