---
title: The InputData class
---
This document explains the <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> class in <SwmPath>[base/src/lgapdb04.java](base/src/lgapdb04.java)</SwmPath>. We will cover:

1. What <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is and its purpose
2. The variables defined in <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>
3. The main functions in <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> that use <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>

# What is <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>

<SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is a static inner class within the <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> class that serves as a data structure to hold input parameters for insurance premium calculations. It encapsulates various attributes related to a customer's insurance risk profile and property details, which are used as inputs to the premium calculation logic.

<SwmSnippet path="/base/src/lgapdb04.java" line="124">

---

The function <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> is the constructor of the <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> class. It initializes the class with a database connection that is used for loading base rates and other data during premium calculations.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="131:5:5" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`calculatePremium`</SwmToken> is the main entry point for calculating insurance premiums. It takes <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>, <SwmToken path="base/src/lgapdb04.java" pos="131:12:12" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`CoverageData`</SwmToken>, and <SwmToken path="base/src/lgapdb04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> objects as parameters and orchestrates the calculation by invoking a series of private methods that perform specific parts of the calculation.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="202:5:5" line-data="    private void p300LoadRates(InputData input, CalculationAreas calc) throws SQLException {">`p300LoadRates`</SwmToken> loads base insurance rates from the database for different perils such as fire, crime, flood, and weather. It uses the input data to query the database and populate base rate values for premium calculations.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="281:5:5" line-data="    private void p500ScheduleMod(InputData input, CalculationAreas calc,">`p500ScheduleMod`</SwmToken> computes the schedule modification factor, which adjusts premiums based on property characteristics like year built, protection class, occupancy code, and exposure density.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="338:5:5" line-data="    private void p600BasePremium(InputData input, CoverageData coverage,">`p600BasePremium`</SwmToken> calculates the base premiums for each peril (fire, crime, flood, weather) using the coverage data, input data, and calculated modifiers.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="399:5:5" line-data="    private void p700CatLoading(CoverageData coverage, CalculationAreas calc,">`p700CatLoading`</SwmToken> calculates catastrophe loading amounts based on coverage data and intermediate calculation results to account for catastrophic risk factors.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="435:5:5" line-data="    private void p800ExpenseAndProfit(CalculationAreas calc, OutputResults output) {">`p800ExpenseAndProfit`</SwmToken> calculates expense and profit loadings that are added to the premium to cover operational costs and profit margins.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="453:5:5" line-data="    private void p900Discounts(InputData input, CoverageData coverage,">`p900Discounts`</SwmToken> applies discounts to the premium based on input data and coverage details, such as multi-peril discounts or claims-free discounts.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="510:5:5" line-data="    private void p950Taxes(OutputResults output) {">`p950Taxes`</SwmToken> calculates taxes on the premium amount using a fixed tax rate and updates the output results accordingly.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="523:5:5" line-data="    private void p999Final(CalculationAreas calc, OutputResults output) {">`p999Final`</SwmToken> performs the final premium calculations by summing all components such as base premium, catastrophe loading, expenses, profit, discounts, and taxes to produce the total premium.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="42">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="42:5:5" line-data="        public String customerNum;">`customerNum`</SwmToken> in <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> stores the unique identifier for the customer.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="43">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="43:5:5" line-data="        public int riskScore;">`riskScore`</SwmToken> holds an integer representing the risk score of the customer, which influences premium calculations.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="44">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="44:5:5" line-data="        public String propertyType;">`propertyType`</SwmToken> is a string describing the type of property insured.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="45">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="45:5:5" line-data="        public String territory;">`territory`</SwmToken> stores the geographic territory or location code of the property.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="46">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="46:5:5" line-data="        public String constructionType;">`constructionType`</SwmToken> describes the type of construction of the property, such as frame or masonry.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="47">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="47:5:5" line-data="        public String occupancyCode;">`occupancyCode`</SwmToken> indicates the occupancy classification of the property, which affects risk assessment.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="48">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="48:5:5" line-data="        public String protectionClass;">`protectionClass`</SwmToken> stores a string representing the protection class rating of the property, used in schedule modification calculations.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="49">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="49:5:5" line-data="        public int yearBuilt;">`yearBuilt`</SwmToken> is an integer representing the year the property was built, used in schedule modification.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="50">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="50:5:5" line-data="        public int squareFootage;">`squareFootage`</SwmToken> holds the size of the property in square feet, used for exposure density calculations.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="51">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="51:5:5" line-data="        public int yearsInBusiness;">`yearsInBusiness`</SwmToken> indicates how long the insured business has been operating, influencing experience modification.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="52">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="52:5:5" line-data="        public int claimsCount5Yr;">`claimsCount5Yr`</SwmToken> stores the number of claims made in the last five years, used in experience modification.
...
<SwmSnippet path="/base/src/lgapdb04.java" line="53">

---

The variable <SwmToken path="base/src/lgapdb04.java" pos="53:5:5" line-data="        public BigDecimal claimsAmount5Yr;">`claimsAmount5Yr`</SwmToken> holds the total amount of claims in the last five years as a <SwmToken path="base/src/lgapdb04.java" pos="53:3:3" line-data="        public BigDecimal claimsAmount5Yr;">`BigDecimal`</SwmToken>, used in experience modification calculations.
...
## <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>

<SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is used as an input parameter in the main calculation method <SwmToken path="base/src/lgapdb04.java" pos="131:5:5" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`calculatePremium`</SwmToken>, where it provides essential data such as customer number, risk score, and property type to perform premium calculations. This method orchestrates the calculation process by passing <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> along with coverage and output data objects.

<SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is also used in the initialization method <SwmToken path="base/src/lgapdb04.java" pos="136:1:1" line-data="        p200Init(inputData, coverageData, calc);">`p200Init`</SwmToken> to calculate risk adjustment factors based on the risk score it contains. This shows that <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> carries critical risk-related information that influences the calculation logic.

In the method <SwmToken path="base/src/lgapdb04.java" pos="139:1:1" line-data="        p300LoadRates(inputData, calc);">`p300LoadRates`</SwmToken>, <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is passed to load base rates from the database, indicating that the input data may affect which rates are retrieved or how they are applied during the premium calculation.

Furthermore, <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is used in the <SwmToken path="base/src/lgapdb04.java" pos="142:1:1" line-data="        p400ExperienceMod(inputData, calc, outputResults);">`p400ExperienceMod`</SwmToken> method to calculate experience modification factors, which likely adjust the premium based on historical or experience-related data contained within <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>.
