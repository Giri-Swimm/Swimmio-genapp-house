...
---
This document covers the class <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> in <SwmPath>[base/src/lgapdb04.java](base/src/lgapdb04.java)</SwmPath>. We will cover:
...
3. The main functions in <SwmToken path="base/src/lgapdb04.java" pos="124:3:3" line-data="    public LGAPDB04(Connection connection) {">`LGAPDB04`</SwmToken> that interact with <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken>
...
The function <SwmToken path="base/src/lgapdb04.java" pos="245:5:5" line-data="    private void p400ExperienceMod(InputData input, CalculationAreas calc,">`p400ExperienceMod`</SwmToken> calculates the experience modification factor based on the input data, particularly years in business and claims history. This factor adjusts the premium to reflect the insured's risk experience.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="435:5:5" line-data="    private void p800ExpenseAndProfit(CalculationAreas calc, OutputResults output) {">`p800ExpenseAndProfit`</SwmToken> computes expense and profit loadings on the premium. It applies predefined ratios to the base premium to cover operational costs and profit margins.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="453:5:5" line-data="    private void p900Discounts(InputData input, CoverageData coverage,">`p900Discounts`</SwmToken> calculates applicable discounts on the premium based on input data and coverage details. It considers factors like multi-peril discounts, claims-free discounts, and deductible credits.
...
The function <SwmToken path="base/src/lgapdb04.java" pos="510:5:5" line-data="    private void p950Taxes(OutputResults output) {">`p950Taxes`</SwmToken> calculates taxes on the premium by applying a fixed tax rate to the base amount, adding the tax amount to the output results.
...
<SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is used as an input parameter in the main calculation method <SwmToken path="base/src/lgapdb04.java" pos="131:5:5" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`calculatePremium`</SwmToken>, where it provides essential data such as customer number, risk score, and property type to perform premium calculations.

## <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> in exposure initialization

In the method <SwmToken path="base/src/lgapdb04.java" pos="136:1:1" line-data="        p200Init(inputData, coverageData, calc);">`p200Init`</SwmToken>, <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is used to initialize exposure calculations. For example, the risk score from <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is used to compute a risk adjustment factor, which influences further calculations.

## <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> in rate loading

The method <SwmToken path="base/src/lgapdb04.java" pos="139:1:1" line-data="        p300LoadRates(inputData, calc);">`p300LoadRates`</SwmToken> uses <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> to load base rates from the database. This method likely uses properties from <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> to determine which rates to load or how to adjust them.

## <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> in experience modification

In the method <SwmToken path="base/src/lgapdb04.java" pos="142:1:1" line-data="        p400ExperienceMod(inputData, calc, outputResults);">`p400ExperienceMod`</SwmToken>, <SwmToken path="base/src/lgapdb04.java" pos="131:7:7" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`InputData`</SwmToken> is used to calculate an experience modification factor, which adjusts the output results based on the input risk characteristics.
