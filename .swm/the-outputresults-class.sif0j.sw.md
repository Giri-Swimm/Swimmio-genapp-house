...
1. What is <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken>
2. Variables and functions
3. Explanation of key functions interacting with <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken>
...
<SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> is a static inner class in <SwmPath>[base/src/LGAPDB04.java](base/src/LGAPDB04.java)</SwmPath> that serves as a data structure to hold the results of the insurance premium calculations. It stores calculated premiums for different perils, premium components such as base amount and loadings, and rating factors used in the actuarial calculations. This class is used to aggregate and return the final premium calculation outputs after processing input data and coverage details.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="131:5:5" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`calculatePremium`</SwmToken> is the main entry point for premium calculation. It takes input data, coverage data, and an <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> instance to populate with calculated premium values. It orchestrates the calculation by calling a series of private methods that perform specific parts of the calculation.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="169:5:5" line-data="    private void p200Init(InputData input, CoverageData coverage, CalculationAreas calc) {">`p200Init`</SwmToken> initializes exposure calculations based on input data and coverage. It computes risk adjustment factors, exposures, total insured value, and exposure density, setting up the calculation context.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="245:5:5" line-data="    private void p400ExperienceMod(InputData input, CalculationAreas calc,">`p400ExperienceMod`</SwmToken> calculates the experience modification factor based on the input data such as years in business and claims history. It updates the <SwmToken path="base/src/LGAPDB04.java" pos="275:3:3" line-data="        output.experienceMod = expMod;">`experienceMod`</SwmToken> field in <SwmToken path="base/src/LGAPDB04.java" pos="246:1:1" line-data="                                   OutputResults output) {">`OutputResults`</SwmToken>.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="281:5:5" line-data="    private void p500ScheduleMod(InputData input, CalculationAreas calc,">`p500ScheduleMod`</SwmToken> calculates the schedule modification factor considering building age, protection class, occupancy hazard, and exposure density. It caps the <SwmToken path="base/src/LGAPDB04.java" pos="332:3:3" line-data="        output.scheduleMod = schedMod;">`scheduleMod`</SwmToken> value within a defined range and updates <SwmToken path="base/src/LGAPDB04.java" pos="282:1:1" line-data="                                 OutputResults output) {">`OutputResults`</SwmToken> accordingly.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="338:5:5" line-data="    private void p600BasePremium(InputData input, CoverageData coverage,">`p600BasePremium`</SwmToken> calculates the base premiums for each peril (fire, crime, flood, weather) using coverage data, calculation areas, and the schedule modifier. It updates the respective peril premiums in <SwmToken path="base/src/LGAPDB04.java" pos="339:6:6" line-data="                                 CalculationAreas calc, OutputResults output) {">`OutputResults`</SwmToken>.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="435:5:5" line-data="    private void p800ExpenseAndProfit(CalculationAreas calc, OutputResults output) {">`p800ExpenseAndProfit`</SwmToken> calculates expense and profit loadings using calculation areas and updates the <SwmToken path="base/src/LGAPDB04.java" pos="440:3:3" line-data="        output.expenseLoadAmt = calc.expenseLoading.setScale(2, RoundingMode.HALF_UP);">`expenseLoadAmt`</SwmToken> and <SwmToken path="base/src/LGAPDB04.java" pos="447:3:3" line-data="        output.profitLoadAmt = calc.profitLoading.setScale(2, RoundingMode.HALF_UP);">`profitLoadAmt`</SwmToken> fields in <SwmToken path="base/src/LGAPDB04.java" pos="435:12:12" line-data="    private void p800ExpenseAndProfit(CalculationAreas calc, OutputResults output) {">`OutputResults`</SwmToken>.
...
The function <SwmToken path="base/src/LGAPDB04.java" pos="453:5:5" line-data="    private void p900Discounts(InputData input, CoverageData coverage,">`p900Discounts`</SwmToken> calculates applicable discounts based on input data, coverage, and calculation areas, updating the <SwmToken path="base/src/LGAPDB04.java" pos="499:3:3" line-data="        output.discountAmt = output.baseAmount">`discountAmt`</SwmToken> in <SwmToken path="base/src/LGAPDB04.java" pos="454:6:6" line-data="                              CalculationAreas calc, OutputResults output) {">`OutputResults`</SwmToken>.
...
The variable <SwmToken path="base/src/LGAPDB04.java" pos="85:5:5" line-data="        public BigDecimal baseAmount = BigDecimal.ZERO;">`baseAmount`</SwmToken> stores the base premium amount before loadings and discounts.
...
<SwmSnippet path="/base/src/LGAPDB04.java" line="93">

---

The variable <SwmToken path="base/src/LGAPDB04.java" pos="93:5:5" line-data="        public BigDecimal experienceMod = BigDecimal.ONE;">`experienceMod`</SwmToken> stores the experience modification factor applied to the premium, initialized to 1.
...
<SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> is used to hold the results of various premium calculations, including specific premiums for different perils such as fire and crime. It acts as a data structure that accumulates calculated values throughout the premium calculation process.
...
In the <SwmToken path="base/src/LGAPDB04.java" pos="131:5:5" line-data="    public void calculatePremium(InputData inputData, CoverageData coverageData,">`calculatePremium`</SwmToken> method, an instance of <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> is passed as a parameter to collect the results of the premium calculation. This method orchestrates the calculation by invoking other helper methods and updating the <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> instance with the computed premiums and modifiers.
...
The <SwmToken path="base/src/LGAPDB04.java" pos="142:1:1" line-data="        p400ExperienceMod(inputData, calc, outputResults);">`p400ExperienceMod`</SwmToken> method uses <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> to store the experience modification factor, which adjusts premiums based on the insured's years in business. This factor is calculated and then saved into the <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> instance.
...
In the <SwmToken path="base/src/LGAPDB04.java" pos="145:1:1" line-data="        p500ScheduleMod(inputData, calc, outputResults);">`p500ScheduleMod`</SwmToken> method, <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> is used to hold the schedule modification factor. This factor is computed considering attributes like building age and is stored in the <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> to be used later in premium calculations.
...
The <SwmToken path="base/src/LGAPDB04.java" pos="148:1:1" line-data="        p600BasePremium(inputData, coverageData, calc, outputResults);">`p600BasePremium`</SwmToken> method calculates the base premiums for each peril, such as fire, by applying the schedule modification factor stored in <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken>. The method updates the <SwmToken path="base/src/LGAPDB04.java" pos="132:1:1" line-data="                                 OutputResults outputResults) throws SQLException {">`OutputResults`</SwmToken> instance with the final premium values after applying all relevant modifiers.
